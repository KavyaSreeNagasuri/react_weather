    ...
    render() {
        return (
          <div className="input-group">
              <input type="text" className="form-control" placeholder="search here" onChange={this.onCityNameChange}/>
              <span className="input-group-btn">
                <button className="bg-primary" id="search" onClick={this.onBtnClick}>search
